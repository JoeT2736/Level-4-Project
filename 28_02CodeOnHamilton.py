...
D = 32         #domain size (square [0, D] x [0, D])
...
class HemelrijkSimulation:          #vvv change to N=None for static plots (but give a number for animation)
    def __init__(self, mode=None, N=None, size=None):
...
#centre of gravity of school
    ...
    def near_n(self):
        ...
        n1 = np.mean(filtered_sort_dist1)
    ...
    def step(self):
        ...
        attract_mask = self.attract_mask(rel_bearing, dist, dist)
...
ax.set_title('Small (a)', fontsize='14')
ax.set_xlabel('Group Size', fontsize='14')
...
ax.set_title('Large (b)', fontsize='14')
ax.set_xlabel('Group Size', fontsize='14')
ax.set_ylabel('Polar Order Parameter', fontsize='14')
ax.legend()
...
plt.tight_layout()
plt.savefig('Centre distance and nearest neighour, 25x mean, D=25, final.png', dpi=400)
#plt.savefig('Hemelrijk 2003 NORMALISED polar order parameter and group velocity (new angles)(new attract func).png', dpi=400)
#plt.show()
